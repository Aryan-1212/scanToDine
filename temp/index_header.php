                ...
                <nav class="Header-nav-container">
                    ...
                    <ul class="Header-nav-list">
                        <?php if (!$is_login) {
                            ...
                            <li class="Header-nav-item"><a href="../commonPages/about_us.php" class="Header-nav-link">About
                                    Us</a></li>
                            ...
                            ?>
                            <li class="Header-nav-item"><a href="../adminModule/adminDashboard.php"
                                    class="Header-nav-link">Dashboard </a></li>
                            ...
                            <li class="Header-nav-item"><a href="../commonPages/profile.php"
                                    class="Header-nav-link">Profile</a></li>
                            <?php
                        }
                        ?>
                    </ul>
