            ...
            <div class="RegisterContainer">
                ...
                <div class="register">
                    <div class="register-box">
                        <h2>Chef's Register</h2>
                        <form method="POST" action="chefRegisterValidate.php" onsubmit="return validate()">
